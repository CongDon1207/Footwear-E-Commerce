      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-sky-200/50 border border-white/50 p-8 space-y-6 relative z-10">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="font-heading text-2xl md:text-3xl text-text-primary font-bold">Create Account</h1>
            <p className="text-text-secondary text-sm">Join us and start your shopping journey</p>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white/80 text-text-muted">Already a member?</span>
          </div>
        </div>
